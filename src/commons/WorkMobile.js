    ...
    <article id="movil" className="estilo-work">
      <div className="work-mobile">
        ...
        <div className="estilo-contenedor-tarjeta">
          ...
          <p>
            E-commerce - Aplicación web con enfoque en contratación de distintos
            servicios del rubro IT.
          </p>
          <ul>
            <li>
          ...
          <ul>
            <li>Tech Stack: React.Js | Redux | Sass | Material UI | Figma</li>
          </ul>
          <ul>
        ...
        <div className="estilo-contenedor-tarjeta">
          ...
          <p>
            E-commerce - Aplicación web que permita la reserva de turnos para
            empresas con sucursales físicas - Proyecto de 5 personas.
          </p>
          <ul>
            <li>
              Colaboré en el Backend con la creación y funcionalidad de rutas,
              tablas, configuración de JWT.
              <br />
        ...
        <div className="estilo-contenedor-tarjeta">
          ...
          <p>
            E-commerce - Venta de cursos on line sobre Programación - Proyecto
            de 5 personas.
          </p>
          <ul>
            <li>
        ...
        <div className="estilo-contenedor-tarjeta">
          ...
          <ul>
            ...
            <br />
            <li>
              Coordiné la logística para que el pasajero se encuentre finalmente
              con su equipaje.
            </li>
            <br />
